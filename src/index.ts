...
export function HTPipeSanitizeParams<
  ...
  TContextInLeft extends TLeft extends HasSanitizeParams<any, any>
    ...
    : never,
  TContextInRight extends TRight extends HasSanitizeParams<any, any>
    ? Parameters<TRight['sanitizeParams']>[0]
    : never,
  TContextOutLeft extends TLeft extends HasSanitizeParams<any, any>
    ? ReturnType<TLeft['sanitizeParams']>[0]
    : never,
  TContextOutRight extends TRight extends HasSanitizeParams<any, any>
    ? ReturnType<TRight['sanitizeParams']>[0]
    : never
>(left: TLeft, right: TRight) {
