...
export function HTPipeSanitizeResponse<
  ...
  TContextInLeft extends TLeft extends HasSanitizeResponse<any, any>
    ...
    : never,
  TContextInRight extends TRight extends HasSanitizeResponse<any, any>
    ? Parameters<TRight['sanitizeResponse']>[0]
    : never,
  TContextOutLeft extends TLeft extends HasSanitizeResponse<any, any>
    ? ReturnType<TLeft['sanitizeResponse']>[0]
    : never,
  TContextOutRight extends TRight extends HasSanitizeResponse<any, any>
    ? ReturnType<TRight['sanitizeResponse']>[0]
    : never
>(left: TLeft, right: TRight) {
